...
export class Cluster_logsResponse implements AdditionalDataHolder, Parsable {
    /** Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well. */
    private _additionalData: Record<string, unknown>;
    /** Retrieved list of Cluster logs. */
    private _items?: LogEntry[] | undefined;
    ...
    /**
     * Instantiates a new cluster_logsResponse and sets the default values.
     */
    public constructor() {
    ...
    public getFieldDeserializers() : Record<string, (node: ParseNode) => void> {
        return {
            "items": n => { this.items = n.getCollectionOfObjectValues<LogEntry>(createLogEntryFromDiscriminatorValue); },
    ...
    /**
     * Gets the items property value. Retrieved list of Cluster logs.
     * @returns a LogEntry
     */
    public get items() {
        return this._items;
    ...
    /**
     * Sets the items property value. Retrieved list of Cluster logs.
     * @param value Value to set for the items property.
     */
    public set items(value: LogEntry[] | undefined) {
        this._items = value;
    };
    /**
    ...
    public serialize(writer: SerializationWriter) : void {
        ...
        writer.writeCollectionOfObjectValues<LogEntry>("items", this.items);
