...
export class CloudRegion implements AdditionalDataHolder, Parsable {
    ...
    /**
     * Gets the id property value. Human-friendly identifier of the region, for example `us-east-1`.
     * @returns a string
     */
    public get id() {
        return this._id;
    ...
    /**
     * Sets the id property value. Human-friendly identifier of the region, for example `us-east-1`.
