...
/**
 * Representation of an addon sub operator. A sub operator is an operatorwho's life cycle is controlled by the addon umbrella operator.
 */
export class AddonSubOperator implements AdditionalDataHolder, Parsable {
    ...
    /**
     * Gets the enabled property value. Indicates if the sub operator is enabled for the addon
     * @returns a boolean
     */
    public get enabled() {
    ...
    /**
     * Sets the enabled property value. Indicates if the sub operator is enabled for the addon
    ...
    /**
     * Gets the operator_name property value. Name of the addon sub operator
     * @returns a string
     */
    ...
    /**
     * Sets the operator_name property value. Name of the addon sub operator
    ...
    /**
     * Gets the operator_namespace property value. Namespace of the addon sub operator
     * @returns a string
     */
    ...
    /**
     * Sets the operator_namespace property value. Namespace of the addon sub operator
