...
/**
 * Builds and executes requests for operations under /api/addons_mgmt/v1/addons/{addon_id}
 */
export class WithAddon_ItemRequestBuilder {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/api/addons_mgmt/v1/addons/{addon_id}{?dryRun*}";
    ...
    /**
     * Gets an item from the ApiSdk.api.addons_mgmt.v1.addons.item.versions.item collection
