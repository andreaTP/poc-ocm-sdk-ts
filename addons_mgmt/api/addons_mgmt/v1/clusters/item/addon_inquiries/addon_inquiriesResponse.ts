...
export class Addon_inquiriesResponse implements AdditionalDataHolder, Parsable {
    /** Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well. */
    private _additionalData: Record<string, unknown>;
    /** Retrieved list of add-ons. */
    private _items?: Addon[] | undefined;
    ...
    /**
     * Instantiates a new addon_inquiriesResponse and sets the default values.
     */
    public constructor() {
    ...
    public getFieldDeserializers() : Record<string, (node: ParseNode) => void> {
        return {
            "items": n => { this.items = n.getCollectionOfObjectValues<Addon>(createAddonFromDiscriminatorValue); },
    ...
    /**
     * Gets the items property value. Retrieved list of add-ons.
     * @returns a Addon
     */
    public get items() {
        return this._items;
    ...
    /**
     * Sets the items property value. Retrieved list of add-ons.
     * @param value Value to set for the items property.
     */
    public set items(value: Addon[] | undefined) {
        this._items = value;
    };
    /**
    ...
    public serialize(writer: SerializationWriter) : void {
        ...
        writer.writeCollectionOfObjectValues<Addon>("items", this.items);
