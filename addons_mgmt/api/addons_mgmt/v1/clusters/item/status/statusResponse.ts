...
export class StatusResponse implements AdditionalDataHolder, Parsable {
    /** Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well. */
    private _additionalData: Record<string, unknown>;
    /** Retrieved list of addon status conditions */
    private _items?: AddonStatus[] | undefined;
    ...
    public getFieldDeserializers() : Record<string, (node: ParseNode) => void> {
        return {
            "items": n => { this.items = n.getCollectionOfObjectValues<AddonStatus>(createAddonStatusFromDiscriminatorValue); },
    ...
    /**
     * Gets the items property value. Retrieved list of addon status conditions
     * @returns a AddonStatus
     */
    public get items() {
        return this._items;
    };
    /**
     * Sets the items property value. Retrieved list of addon status conditions
     * @param value Value to set for the items property.
     */
    public set items(value: AddonStatus[] | undefined) {
        this._items = value;
    };
    /**
    ...
    public serialize(writer: SerializationWriter) : void {
        ...
        writer.writeCollectionOfObjectValues<AddonStatus>("items", this.items);
