 ...
 */
export class Product implements AdditionalDataHolder, Parsable {
    ...
    /**
     * Gets the kind property value. Indicates the type of this object. Will be 'Product' if this is a complete object or 'ProductLink' if it is just a link.
     * @returns a string
     */
    public get kind() {
        return this._kind;
    ...
    /**
     * Sets the kind property value. Indicates the type of this object. Will be 'Product' if this is a complete object or 'ProductLink' if it is just a link.
    ...
    /**
     * Gets the name property value. Name of the product.
     * @returns a string
     */
    public get name() {
        return this._name;
    ...
    /**
     * Sets the name property value. Name of the product.
