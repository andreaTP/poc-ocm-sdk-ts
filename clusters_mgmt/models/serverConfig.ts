 ...
 */
export class ServerConfig implements AdditionalDataHolder, Parsable {
    ...
    /**
     * Instantiates a new ServerConfig and sets the default values.
     */
    public constructor() {
    ...
    public getFieldDeserializers() : Record<string, (node: ParseNode) => void> {
        return {
            ...
            "server": n => { this.server = n.getStringValue(); },
        };
    };
    /**
    ...
    /**
     * Gets the kind property value. Indicates the type of this object. Will be 'ServerConfig' if this is a complete object or 'ServerConfigLink' if it is just a link.
     * @returns a string
     */
    public get kind() {
        return this._kind;
    ...
    /**
     * Sets the kind property value. Indicates the type of this object. Will be 'ServerConfig' if this is a complete object or 'ServerConfigLink' if it is just a link.
    ...
    /**
     * Gets the kubeconfig property value. The kubeconfig of the server
     * @returns a string
     */
    ...
    /**
     * Sets the kubeconfig property value. The kubeconfig of the server
    ...
    public serialize(writer: SerializationWriter) : void {
        ...
        writer.writeStringValue("server", this.server);
        writer.writeAdditionalData(this.additionalData);
    };
    /**
     * Gets the server property value. The URL of the server
     * @returns a string
     */
    public get server() {
        return this._server;
    ...
    /**
     * Sets the server property value. The URL of the server
