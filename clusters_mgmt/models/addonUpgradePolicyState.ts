 ...
 */
export class AddonUpgradePolicyState implements AdditionalDataHolder, Parsable {
    ...
    /**
     * Instantiates a new AddonUpgradePolicyState and sets the default values.
     */
    public constructor() {
    ...
    /**
     * Gets the kind property value. Indicates the type of this object. Will be 'AddonUpgradePolicyState' if this is a complete object or 'AddonUpgradePolicyStateLink' if it is just a link.
     * @returns a string
     */
    public get kind() {
        return this._kind;
    ...
    /**
     * Sets the kind property value. Indicates the type of this object. Will be 'AddonUpgradePolicyState' if this is a complete object or 'AddonUpgradePolicyStateLink' if it is just a link.
