...
export class AddOnEnvironmentVariable implements AdditionalDataHolder, Parsable {
    ...
    /**
     * Gets the kind property value. Indicates the type of this object. Will be 'AddOnEnvironmentVariable' if this is a complete object or 'AddOnEnvironmentVariableLink' if it is just a link.
     * @returns a string
     */
    public get kind() {
        return this._kind;
    ...
    /**
     * Sets the kind property value. Indicates the type of this object. Will be 'AddOnEnvironmentVariable' if this is a complete object or 'AddOnEnvironmentVariableLink' if it is just a link.
    ...
    /**
     * Gets the name property value. Name of the env object.
     * @returns a string
     */
    public get name() {
        return this._name;
    ...
    /**
     * Sets the name property value. Name of the env object.
    ...
    /**
     * Gets the value property value. Value of the env object.
     * @returns a string
     */
    public get value() {
        return this._value;
    ...
    /**
     * Sets the value property value. Value of the env object.
