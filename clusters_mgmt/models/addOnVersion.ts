...
export class AddOnVersion implements AdditionalDataHolder, Parsable {
    ...
    /**
     * Gets the enabled property value. Indicates if this add-on version can be added to clusters.
     * @returns a boolean
     */
    public get enabled() {
    ...
    /**
     * Sets the enabled property value. Indicates if this add-on version can be added to clusters.
    ...
    /**
     * Gets the parameters property value. List of parameters for this add-on version.
    ...
    /**
     * Sets the parameters property value. List of parameters for this add-on version.
    ...
    /**
     * Gets the requirements property value. List of requirements for this add-on version.
    ...
    /**
     * Sets the requirements property value. List of requirements for this add-on version.
    ...
    /**
     * Gets the source_image property value. The catalog source image for this add-on version.
     * @returns a string
     */
    ...
    /**
     * Sets the source_image property value. The catalog source image for this add-on version.
    ...
    /**
     * Gets the sub_operators property value. List of sub operators for this add-on version.
    ...
    /**
     * Sets the sub_operators property value. List of sub operators for this add-on version.
