...
import {createAddOn_common_annotationsFromDiscriminatorValue} from './createAddOn_common_annotationsFromDiscriminatorValue';
import {createAddOn_common_labelsFromDiscriminatorValue} from './createAddOn_common_labelsFromDiscriminatorValue';
...
import {AddOn_common_annotations, AddOn_common_labels, AddOnConfig, AddOnNamespace, AddOnParameter, AddOnRequirement, AddOnSubOperator, AddOnVersion, CredentialRequest} from './index';
...
export class AddOn implements AdditionalDataHolder, Parsable {
    ...
    private _common_annotations?: AddOn_common_annotations | undefined;
    /** Common labels to be applied to all resources created by this addon. */
    private _common_labels?: AddOn_common_labels | undefined;
    ...
    /**
     * Gets the common_annotations property value. Common annotations to be applied to all resources created by this addon.
     * @returns a AddOn_common_annotations
     */
    public get common_annotations() {
        return this._common_annotations;
    };
    /**
     * Sets the common_annotations property value. Common annotations to be applied to all resources created by this addon.
     * @param value Value to set for the common_annotations property.
     */
    public set common_annotations(value: AddOn_common_annotations | undefined) {
        this._common_annotations = value;
    };
    /**
     * Gets the common_labels property value. Common labels to be applied to all resources created by this addon.
     * @returns a AddOn_common_labels
     */
    public get common_labels() {
        return this._common_labels;
    };
    /**
     * Sets the common_labels property value. Common labels to be applied to all resources created by this addon.
     * @param value Value to set for the common_labels property.
     */
    public set common_labels(value: AddOn_common_labels | undefined) {
        this._common_labels = value;
    };
    /**
     * Gets the config property value. Representation of an add-on config.The attributes under it are to be used by the addon once its installed in the cluster.
    ...
    /**
     * Sets the config property value. Representation of an add-on config.The attributes under it are to be used by the addon once its installed in the cluster.
    ...
    /**
     * Gets the description property value. Description of the add-on.
     * @returns a string
     */
    ...
    /**
     * Sets the description property value. Description of the add-on.
    ...
    /**
     * Gets the docs_link property value. Link to documentation about the add-on.
     * @returns a string
     */
    ...
    /**
     * Sets the docs_link property value. Link to documentation about the add-on.
    ...
    /**
     * Gets the enabled property value. Indicates if this add-on can be added to clusters.
     * @returns a boolean
     */
    public get enabled() {
    ...
    /**
     * Sets the enabled property value. Indicates if this add-on can be added to clusters.
    ...
    public getFieldDeserializers() : Record<string, (node: ParseNode) => void> {
        return {
            "common_annotations": n => { this.common_annotations = n.getObjectValue<AddOn_common_annotations>(createAddOn_common_annotationsFromDiscriminatorValue); },
            "common_labels": n => { this.common_labels = n.getObjectValue<AddOn_common_labels>(createAddOn_common_labelsFromDiscriminatorValue); },
    ...
    /**
     * Gets the has_external_resources property value. Indicates if this add-on has external resources associated with it
     * @returns a boolean
     */
    ...
    /**
     * Sets the has_external_resources property value. Indicates if this add-on has external resources associated with it
    ...
    /**
     * Gets the hidden property value. Indicates if this add-on is hidden.
     * @returns a boolean
     */
    public get hidden() {
        return this._hidden;
    ...
    /**
     * Sets the hidden property value. Indicates if this add-on is hidden.
    ...
    /**
     * Gets the icon property value. Base64-encoded icon representing an add-on. The icon should be in PNG format.
     * @returns a string
     */
    public get icon() {
        return this._icon;
    ...
    /**
     * Sets the icon property value. Base64-encoded icon representing an add-on. The icon should be in PNG format.
    ...
    /**
     * Gets the install_mode property value. Representation of an add-on InstallMode field.
    ...
    /**
     * Sets the install_mode property value. Representation of an add-on InstallMode field.
    ...
    /**
     * Gets the label property value. Label used to attach to a cluster deployment when add-on is installed.
     * @returns a string
     */
    public get label() {
        return this._label;
    ...
    /**
     * Sets the label property value. Label used to attach to a cluster deployment when add-on is installed.
    ...
    /**
     * Gets the managed_service property value. Indicates if add-on is part of a managed service
     * @returns a boolean
     */
    ...
    /**
     * Sets the managed_service property value. Indicates if add-on is part of a managed service
    ...
    /**
     * Gets the name property value. Name of the add-on.
     * @returns a string
     */
    public get name() {
        return this._name;
    ...
    /**
     * Sets the name property value. Name of the add-on.
    ...
    /**
     * Gets the namespaces property value. Namespaces which are required by this addon.
    ...
    /**
     * Sets the namespaces property value. Namespaces which are required by this addon.
    ...
    /**
     * Gets the operator_name property value. The name of the operator installed by this add-on.
     * @returns a string
     */
    ...
    /**
     * Sets the operator_name property value. The name of the operator installed by this add-on.
    ...
    /**
     * Gets the parameters property value. List of parameters for this add-on.
    ...
    /**
     * Sets the parameters property value. List of parameters for this add-on.
    ...
    /**
     * Gets the requirements property value. List of requirements for this add-on.
    ...
    /**
     * Sets the requirements property value. List of requirements for this add-on.
    ...
    /**
     * Gets the resource_cost property value. Used to determine how many units of quota an add-on consumes per resource name.
     * @returns a float
     */
    ...
    /**
     * Sets the resource_cost property value. Used to determine how many units of quota an add-on consumes per resource name.
    ...
    /**
     * Gets the resource_name property value. Used to determine from where to reserve quota for this add-on.
     * @returns a string
     */
    ...
    /**
     * Sets the resource_name property value. Used to determine from where to reserve quota for this add-on.
    ...
    public serialize(writer: SerializationWriter) : void {
        ...
        writer.writeObjectValue<AddOn_common_annotations>("common_annotations", this.common_annotations);
        writer.writeObjectValue<AddOn_common_labels>("common_labels", this.common_labels);
    ...
    /**
     * Gets the sub_operators property value. List of sub operators for this add-on.
    ...
    /**
     * Sets the sub_operators property value. List of sub operators for this add-on.
    ...
    /**
     * Gets the version property value. Representation of an add-on version.
    ...
    /**
     * Sets the version property value. Representation of an add-on version.
