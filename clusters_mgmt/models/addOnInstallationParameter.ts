 ...
 */
export class AddOnInstallationParameter implements AdditionalDataHolder, Parsable {
    ...
    /**
     * Instantiates a new AddOnInstallationParameter and sets the default values.
     */
    public constructor() {
    ...
    /**
     * Gets the kind property value. Indicates the type of this object. Will be 'AddOnInstallationParameter' if this is a complete object or 'AddOnInstallationParameterLink' if it is just a link.
     * @returns a string
     */
    public get kind() {
        return this._kind;
    ...
    /**
     * Sets the kind property value. Indicates the type of this object. Will be 'AddOnInstallationParameter' if this is a complete object or 'AddOnInstallationParameterLink' if it is just a link.
