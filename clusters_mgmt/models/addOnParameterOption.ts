...
export class AddOnParameterOption implements AdditionalDataHolder, Parsable {
    ...
    /**
     * Gets the name property value. Name of the add-on parameter option.
     * @returns a string
     */
    public get name() {
        return this._name;
    ...
    /**
     * Sets the name property value. Name of the add-on parameter option.
    ...
    /**
     * Gets the requirements property value. List of add-on requirements for this parameter option.
    ...
    /**
     * Sets the requirements property value. List of add-on requirements for this parameter option.
    ...
    /**
     * Gets the value property value. Value of the add-on parameter option.
     * @returns a string
     */
    public get value() {
        return this._value;
    ...
    /**
     * Sets the value property value. Value of the add-on parameter option.
