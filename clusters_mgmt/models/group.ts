 ...
 */
export class Group implements AdditionalDataHolder, Parsable {
    ...
    /**
     * Gets the kind property value. Indicates the type of this object. Will be 'Group' if this is a complete object or 'GroupLink' if it is just a link.
     * @returns a string
     */
    public get kind() {
        return this._kind;
    ...
    /**
     * Sets the kind property value. Indicates the type of this object. Will be 'Group' if this is a complete object or 'GroupLink' if it is just a link.
    ...
    /**
     * Gets the users property value. List of users of the group.
     * @returns a User
     */
    public get users() {
        return this._users;
    ...
    /**
     * Sets the users property value. List of users of the group.
