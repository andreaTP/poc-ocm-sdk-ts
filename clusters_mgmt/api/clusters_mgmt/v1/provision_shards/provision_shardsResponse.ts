...
export class Provision_shardsResponse implements AdditionalDataHolder, Parsable {
    /** Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well. */
    private _additionalData: Record<string, unknown>;
    /** Retrieved a list of provision shards. */
    private _items?: ProvisionShard[] | undefined;
    ...
    /**
     * Instantiates a new provision_shardsResponse and sets the default values.
     */
    public constructor() {
    ...
    public getFieldDeserializers() : Record<string, (node: ParseNode) => void> {
        return {
            "items": n => { this.items = n.getCollectionOfObjectValues<ProvisionShard>(createProvisionShardFromDiscriminatorValue); },
    ...
    /**
     * Gets the items property value. Retrieved a list of provision shards.
    ...
    /**
     * Sets the items property value. Retrieved a list of provision shards.
     * @param value Value to set for the items property.
     */
    public set items(value: ProvisionShard[] | undefined) {
        this._items = value;
    };
    /**
    ...
    public serialize(writer: SerializationWriter) : void {
        ...
        writer.writeCollectionOfObjectValues<ProvisionShard>("items", this.items);
