...
export class Available_regionsResponse implements AdditionalDataHolder, Parsable {
    ...
    /**
     * Instantiates a new available_regionsResponse and sets the default values.
     */
    public constructor() {
    ...
    /**
     * Gets the items property value. Retrieved list of cloud regions.
    ...
    /**
     * Sets the items property value. Retrieved list of cloud regions.
