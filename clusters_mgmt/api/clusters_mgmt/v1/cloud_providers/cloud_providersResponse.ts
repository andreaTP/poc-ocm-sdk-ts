...
export class Cloud_providersResponse implements AdditionalDataHolder, Parsable {
    /** Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well. */
    private _additionalData: Record<string, unknown>;
    /** Retrieved list of cloud providers. */
    private _items?: CloudProvider[] | undefined;
    ...
    /**
     * Instantiates a new cloud_providersResponse and sets the default values.
     */
    public constructor() {
    ...
    public getFieldDeserializers() : Record<string, (node: ParseNode) => void> {
        return {
            "items": n => { this.items = n.getCollectionOfObjectValues<CloudProvider>(createCloudProviderFromDiscriminatorValue); },
     ...
     */
    public set items(value: CloudProvider[] | undefined) {
        this._items = value;
    };
    /**
    ...
    public serialize(writer: SerializationWriter) : void {
        ...
        writer.writeCollectionOfObjectValues<CloudProvider>("items", this.items);
