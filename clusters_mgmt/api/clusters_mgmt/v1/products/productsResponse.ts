...
export class ProductsResponse implements AdditionalDataHolder, Parsable {
    /** Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well. */
    private _additionalData: Record<string, unknown>;
    /** Retrieved list of products. */
    private _items?: Product[] | undefined;
    ...
    /**
     * Instantiates a new productsResponse and sets the default values.
     */
    public constructor() {
    ...
    public getFieldDeserializers() : Record<string, (node: ParseNode) => void> {
        return {
            "items": n => { this.items = n.getCollectionOfObjectValues<Product>(createProductFromDiscriminatorValue); },
    ...
    /**
     * Gets the items property value. Retrieved list of products.
     * @returns a Product
     */
    public get items() {
        return this._items;
    ...
    /**
     * Sets the items property value. Retrieved list of products.
     * @param value Value to set for the items property.
     */
    public set items(value: Product[] | undefined) {
        this._items = value;
    };
    /**
    ...
    public serialize(writer: SerializationWriter) : void {
        ...
        writer.writeCollectionOfObjectValues<Product>("items", this.items);
