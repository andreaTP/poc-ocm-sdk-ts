...
export class FlavoursResponse implements AdditionalDataHolder, Parsable {
    /** Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well. */
    private _additionalData: Record<string, unknown>;
    /** Retrieved list of flavours. */
    private _items?: Flavour[] | undefined;
    ...
    /**
     * Instantiates a new flavoursResponse and sets the default values.
     */
    public constructor() {
    ...
    public getFieldDeserializers() : Record<string, (node: ParseNode) => void> {
        return {
            "items": n => { this.items = n.getCollectionOfObjectValues<Flavour>(createFlavourFromDiscriminatorValue); },
    ...
    /**
     * Gets the items property value. Retrieved list of flavours.
     * @returns a Flavour
     */
    public get items() {
        return this._items;
    ...
    /**
     * Sets the items property value. Retrieved list of flavours.
     * @param value Value to set for the items property.
     */
    public set items(value: Flavour[] | undefined) {
        this._items = value;
    };
    /**
    ...
    public serialize(writer: SerializationWriter) : void {
        ...
        writer.writeCollectionOfObjectValues<Flavour>("items", this.items);
