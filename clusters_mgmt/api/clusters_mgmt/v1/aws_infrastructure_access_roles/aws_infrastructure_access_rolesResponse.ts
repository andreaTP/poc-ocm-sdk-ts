...
export class Aws_infrastructure_access_rolesResponse implements AdditionalDataHolder, Parsable {
    /** Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well. */
    private _additionalData: Record<string, unknown>;
    /** Retrieved list of roles. */
    private _items?: AWSInfrastructureAccessRole[] | undefined;
    ...
    /**
     * Instantiates a new aws_infrastructure_access_rolesResponse and sets the default values.
     */
    public constructor() {
    ...
    public getFieldDeserializers() : Record<string, (node: ParseNode) => void> {
        return {
            "items": n => { this.items = n.getCollectionOfObjectValues<AWSInfrastructureAccessRole>(createAWSInfrastructureAccessRoleFromDiscriminatorValue); },
    ...
    /**
     * Gets the items property value. Retrieved list of roles.
    ...
    /**
     * Sets the items property value. Retrieved list of roles.
     * @param value Value to set for the items property.
     */
    public set items(value: AWSInfrastructureAccessRole[] | undefined) {
        this._items = value;
    };
    /**
    ...
    public serialize(writer: SerializationWriter) : void {
        ...
        writer.writeCollectionOfObjectValues<AWSInfrastructureAccessRole>("items", this.items);
