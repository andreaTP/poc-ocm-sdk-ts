...
export class Version_gatesResponse implements AdditionalDataHolder, Parsable {
    /** Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well. */
    private _additionalData: Record<string, unknown>;
    /** Retrieved list of version gates. */
    private _items?: VersionGate[] | undefined;
    ...
    /**
     * Instantiates a new version_gatesResponse and sets the default values.
     */
    public constructor() {
    ...
    public getFieldDeserializers() : Record<string, (node: ParseNode) => void> {
        return {
            "items": n => { this.items = n.getCollectionOfObjectValues<VersionGate>(createVersionGateFromDiscriminatorValue); },
    ...
    /**
     * Gets the items property value. Retrieved list of version gates.
    ...
    /**
     * Sets the items property value. Retrieved list of version gates.
     * @param value Value to set for the items property.
     */
    public set items(value: VersionGate[] | undefined) {
        this._items = value;
    };
    /**
    ...
    public serialize(writer: SerializationWriter) : void {
        ...
        writer.writeCollectionOfObjectValues<VersionGate>("items", this.items);
    ...
    /**
     * Gets the size property value. Maximum number of items that will be contained in the returned page.Default value is `100`.
     * @returns a integer
     */
    public get size() {
        return this._size;
    ...
    /**
     * Sets the size property value. Maximum number of items that will be contained in the returned page.Default value is `100`.
