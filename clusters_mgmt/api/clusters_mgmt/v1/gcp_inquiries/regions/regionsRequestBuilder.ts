...
/**
 * Builds and executes requests for operations under /api/clusters_mgmt/v1/gcp_inquiries/regions
 */
export class RegionsRequestBuilder {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/api/clusters_mgmt/v1/gcp_inquiries/regions{?page*,size*}";
