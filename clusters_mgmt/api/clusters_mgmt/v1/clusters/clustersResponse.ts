...
export class ClustersResponse implements AdditionalDataHolder, Parsable {
    /** Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well. */
    private _additionalData: Record<string, unknown>;
    /** Retrieved list of clusters. */
    private _items?: Cluster[] | undefined;
    ...
    /**
     * Instantiates a new clustersResponse and sets the default values.
     */
    public constructor() {
    ...
    public getFieldDeserializers() : Record<string, (node: ParseNode) => void> {
        return {
            "items": n => { this.items = n.getCollectionOfObjectValues<Cluster>(createClusterFromDiscriminatorValue); },
    ...
    /**
     * Gets the items property value. Retrieved list of clusters.
     * @returns a Cluster
     */
    public get items() {
        return this._items;
    ...
    /**
     * Sets the items property value. Retrieved list of clusters.
     * @param value Value to set for the items property.
     */
    public set items(value: Cluster[] | undefined) {
        this._items = value;
    };
    /**
    ...
    public serialize(writer: SerializationWriter) : void {
        ...
        writer.writeCollectionOfObjectValues<Cluster>("items", this.items);
