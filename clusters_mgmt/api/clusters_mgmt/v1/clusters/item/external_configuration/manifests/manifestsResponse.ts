...
export class ManifestsResponse implements AdditionalDataHolder, Parsable {
    /** Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well. */
    private _additionalData: Record<string, unknown>;
    /** Retrieved list of Manifests. */
    private _items?: Manifest[] | undefined;
    ...
    /**
     * Instantiates a new manifestsResponse and sets the default values.
     */
    public constructor() {
    ...
    public getFieldDeserializers() : Record<string, (node: ParseNode) => void> {
        return {
            "items": n => { this.items = n.getCollectionOfObjectValues<Manifest>(createManifestFromDiscriminatorValue); },
    ...
    /**
     * Gets the items property value. Retrieved list of Manifests.
     * @returns a Manifest
     */
    public get items() {
        return this._items;
    ...
    /**
     * Sets the items property value. Retrieved list of Manifests.
     * @param value Value to set for the items property.
     */
    public set items(value: Manifest[] | undefined) {
        this._items = value;
    };
    /**
    ...
    public serialize(writer: SerializationWriter) : void {
        ...
        writer.writeCollectionOfObjectValues<Manifest>("items", this.items);
