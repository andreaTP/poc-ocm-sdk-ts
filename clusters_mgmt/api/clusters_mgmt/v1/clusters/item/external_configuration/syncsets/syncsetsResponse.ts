...
export class SyncsetsResponse implements AdditionalDataHolder, Parsable {
    /** Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well. */
    private _additionalData: Record<string, unknown>;
    /** Retrieved list of syncsets. */
    private _items?: Syncset[] | undefined;
    ...
    /**
     * Instantiates a new syncsetsResponse and sets the default values.
     */
    public constructor() {
    ...
    public getFieldDeserializers() : Record<string, (node: ParseNode) => void> {
        return {
            "items": n => { this.items = n.getCollectionOfObjectValues<Syncset>(createSyncsetFromDiscriminatorValue); },
    ...
    /**
     * Gets the items property value. Retrieved list of syncsets.
     * @returns a Syncset
     */
    public get items() {
        return this._items;
    ...
    /**
     * Sets the items property value. Retrieved list of syncsets.
     * @param value Value to set for the items property.
     */
    public set items(value: Syncset[] | undefined) {
        this._items = value;
    };
    /**
    ...
    public serialize(writer: SerializationWriter) : void {
        ...
        writer.writeCollectionOfObjectValues<Syncset>("items", this.items);
