...
export class Htpasswd_usersResponse implements AdditionalDataHolder, Parsable {
    ...
    /**
     * Instantiates a new htpasswd_usersResponse and sets the default values.
     */
    public constructor() {
    ...
    /**
     * Gets the items property value. Retrieved list of users of the IDP.
    ...
    /**
     * Sets the items property value. Retrieved list of users of the IDP.
