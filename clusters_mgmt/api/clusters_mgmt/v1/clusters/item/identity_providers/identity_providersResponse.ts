...
export class Identity_providersResponse implements AdditionalDataHolder, Parsable {
    /** Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well. */
    private _additionalData: Record<string, unknown>;
    /** Retrieved list of identity providers. */
    private _items?: IdentityProvider[] | undefined;
    ...
    /**
     * Instantiates a new identity_providersResponse and sets the default values.
     */
    public constructor() {
    ...
    public getFieldDeserializers() : Record<string, (node: ParseNode) => void> {
        return {
            "items": n => { this.items = n.getCollectionOfObjectValues<IdentityProvider>(createIdentityProviderFromDiscriminatorValue); },
    ...
    /**
     * Gets the items property value. Retrieved list of identity providers.
    ...
    /**
     * Sets the items property value. Retrieved list of identity providers.
     * @param value Value to set for the items property.
     */
    public set items(value: IdentityProvider[] | undefined) {
        this._items = value;
    };
    /**
    ...
    public serialize(writer: SerializationWriter) : void {
        ...
        writer.writeCollectionOfObjectValues<IdentityProvider>("items", this.items);
