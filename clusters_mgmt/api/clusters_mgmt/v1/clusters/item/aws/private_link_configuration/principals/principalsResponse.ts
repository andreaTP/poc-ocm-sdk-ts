...
export class PrincipalsResponse implements AdditionalDataHolder, Parsable {
    /** Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well. */
    private _additionalData: Record<string, unknown>;
    /** Retrieved list of principals. */
    private _items?: PrivateLinkPrincipal[] | undefined;
    ...
    public getFieldDeserializers() : Record<string, (node: ParseNode) => void> {
        return {
            "items": n => { this.items = n.getCollectionOfObjectValues<PrivateLinkPrincipal>(createPrivateLinkPrincipalFromDiscriminatorValue); },
    ...
    /**
     * Gets the items property value. Retrieved list of principals.
    ...
    /**
     * Sets the items property value. Retrieved list of principals.
     * @param value Value to set for the items property.
     */
    public set items(value: PrivateLinkPrincipal[] | undefined) {
        this._items = value;
    };
    /**
    ...
    public serialize(writer: SerializationWriter) : void {
        ...
        writer.writeCollectionOfObjectValues<PrivateLinkPrincipal>("items", this.items);
