...
export class Limited_support_reasonsResponse implements AdditionalDataHolder, Parsable {
    /** Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well. */
    private _additionalData: Record<string, unknown>;
    /** Retrieved list of template. */
    private _items?: LimitedSupportReason[] | undefined;
    ...
    /**
     * Instantiates a new limited_support_reasonsResponse and sets the default values.
     */
    public constructor() {
    ...
    public getFieldDeserializers() : Record<string, (node: ParseNode) => void> {
        return {
            "items": n => { this.items = n.getCollectionOfObjectValues<LimitedSupportReason>(createLimitedSupportReasonFromDiscriminatorValue); },
     ...
     * @returns a LimitedSupportReason
     */
    public get items() {
        return this._items;
    };
     ...
     */
    public set items(value: LimitedSupportReason[] | undefined) {
        this._items = value;
    };
    /**
    ...
    public serialize(writer: SerializationWriter) : void {
        ...
        writer.writeCollectionOfObjectValues<LimitedSupportReason>("items", this.items);
