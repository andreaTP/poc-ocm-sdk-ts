...
export class IngressesResponse implements AdditionalDataHolder, Parsable {
    /** Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well. */
    private _additionalData: Record<string, unknown>;
    /** Retrieved list of ingresses. */
    private _items?: Ingress[] | undefined;
    ...
    /**
     * Instantiates a new ingressesResponse and sets the default values.
     */
    public constructor() {
    ...
    public getFieldDeserializers() : Record<string, (node: ParseNode) => void> {
        return {
            "items": n => { this.items = n.getCollectionOfObjectValues<Ingress>(createIngressFromDiscriminatorValue); },
    ...
    /**
     * Gets the items property value. Retrieved list of ingresses.
     * @returns a Ingress
     */
    public get items() {
        return this._items;
    ...
    /**
     * Sets the items property value. Retrieved list of ingresses.
     * @param value Value to set for the items property.
     */
    public set items(value: Ingress[] | undefined) {
        this._items = value;
    };
    /**
    ...
    public serialize(writer: SerializationWriter) : void {
        ...
        writer.writeCollectionOfObjectValues<Ingress>("items", this.items);
