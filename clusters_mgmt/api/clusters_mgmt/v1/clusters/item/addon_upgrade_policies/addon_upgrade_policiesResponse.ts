...
export class Addon_upgrade_policiesResponse implements AdditionalDataHolder, Parsable {
    /** Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well. */
    private _additionalData: Record<string, unknown>;
    /** Retrieved list of addon upgrade policy. */
    private _items?: AddonUpgradePolicy[] | undefined;
    ...
    /**
     * Instantiates a new addon_upgrade_policiesResponse and sets the default values.
     */
    public constructor() {
    ...
    public getFieldDeserializers() : Record<string, (node: ParseNode) => void> {
        return {
            "items": n => { this.items = n.getCollectionOfObjectValues<AddonUpgradePolicy>(createAddonUpgradePolicyFromDiscriminatorValue); },
    ...
    /**
     * Gets the items property value. Retrieved list of addon upgrade policy.
     * @returns a AddonUpgradePolicy
     */
    public get items() {
        return this._items;
    };
    /**
     * Sets the items property value. Retrieved list of addon upgrade policy.
     * @param value Value to set for the items property.
     */
    public set items(value: AddonUpgradePolicy[] | undefined) {
        this._items = value;
    };
    /**
    ...
    public serialize(writer: SerializationWriter) : void {
        ...
        writer.writeCollectionOfObjectValues<AddonUpgradePolicy>("items", this.items);
