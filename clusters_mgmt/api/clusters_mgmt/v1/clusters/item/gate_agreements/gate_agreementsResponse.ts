...
export class Gate_agreementsResponse implements AdditionalDataHolder, Parsable {
    /** Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well. */
    private _additionalData: Record<string, unknown>;
    /** Retrieved list of version gate agreement. */
    private _items?: VersionGateAgreement[] | undefined;
    ...
    /**
     * Instantiates a new gate_agreementsResponse and sets the default values.
     */
    public constructor() {
    ...
    public getFieldDeserializers() : Record<string, (node: ParseNode) => void> {
        return {
            "items": n => { this.items = n.getCollectionOfObjectValues<VersionGateAgreement>(createVersionGateAgreementFromDiscriminatorValue); },
    ...
    /**
     * Gets the items property value. Retrieved list of version gate agreement.
     * @returns a VersionGateAgreement
     */
    public get items() {
        return this._items;
    };
    /**
     * Sets the items property value. Retrieved list of version gate agreement.
     * @param value Value to set for the items property.
     */
    public set items(value: VersionGateAgreement[] | undefined) {
        this._items = value;
    };
    /**
    ...
    public serialize(writer: SerializationWriter) : void {
        ...
        writer.writeCollectionOfObjectValues<VersionGateAgreement>("items", this.items);
