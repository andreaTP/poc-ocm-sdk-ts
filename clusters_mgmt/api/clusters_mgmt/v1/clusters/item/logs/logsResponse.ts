...
export class LogsResponse implements AdditionalDataHolder, Parsable {
    /** Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well. */
    private _additionalData: Record<string, unknown>;
    /** Retrieved list of log links. */
    private _items?: Log[] | undefined;
    ...
    /**
     * Instantiates a new logsResponse and sets the default values.
     */
    public constructor() {
    ...
    public getFieldDeserializers() : Record<string, (node: ParseNode) => void> {
        return {
            "items": n => { this.items = n.getCollectionOfObjectValues<Log>(createLogFromDiscriminatorValue); },
    ...
    /**
     * Gets the items property value. Retrieved list of log links.
     * @returns a Log
     */
    public get items() {
        return this._items;
    ...
    /**
     * Sets the items property value. Retrieved list of log links.
     * @param value Value to set for the items property.
     */
    public set items(value: Log[] | undefined) {
        this._items = value;
    };
    /**
    ...
    public serialize(writer: SerializationWriter) : void {
        ...
        writer.writeCollectionOfObjectValues<Log>("items", this.items);
