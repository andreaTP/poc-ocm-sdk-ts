...
export class Sts_operator_rolesResponse implements AdditionalDataHolder, Parsable {
    /** Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well. */
    private _additionalData: Record<string, unknown>;
    /** Retrieved list of operator roles. */
    private _items?: OperatorIAMRole[] | undefined;
    ...
    /**
     * Instantiates a new sts_operator_rolesResponse and sets the default values.
     */
    public constructor() {
    ...
    public getFieldDeserializers() : Record<string, (node: ParseNode) => void> {
        return {
            "items": n => { this.items = n.getCollectionOfObjectValues<OperatorIAMRole>(createOperatorIAMRoleFromDiscriminatorValue); },
    ...
    /**
     * Gets the items property value. Retrieved list of operator roles.
    ...
    /**
     * Sets the items property value. Retrieved list of operator roles.
     * @param value Value to set for the items property.
     */
    public set items(value: OperatorIAMRole[] | undefined) {
        this._items = value;
    };
    /**
    ...
    public serialize(writer: SerializationWriter) : void {
        ...
        writer.writeCollectionOfObjectValues<OperatorIAMRole>("items", this.items);
    ...
    /**
     * Gets the size property value. Number of items that will be contained in the returned page.
     * @returns a integer
     */
    public get size() {
        return this._size;
    ...
    /**
     * Sets the size property value. Number of items that will be contained in the returned page.
