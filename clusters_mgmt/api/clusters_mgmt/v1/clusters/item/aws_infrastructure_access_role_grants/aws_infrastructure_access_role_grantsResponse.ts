...
export class Aws_infrastructure_access_role_grantsResponse implements AdditionalDataHolder, Parsable {
    /** Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well. */
    private _additionalData: Record<string, unknown>;
    /** Retrieved list of AWS infrastructure access role grants. */
    private _items?: AWSInfrastructureAccessRoleGrant[] | undefined;
    ...
    /**
     * Instantiates a new aws_infrastructure_access_role_grantsResponse and sets the default values.
     */
    public constructor() {
    ...
    public getFieldDeserializers() : Record<string, (node: ParseNode) => void> {
        return {
            "items": n => { this.items = n.getCollectionOfObjectValues<AWSInfrastructureAccessRoleGrant>(createAWSInfrastructureAccessRoleGrantFromDiscriminatorValue); },
    ...
    /**
     * Gets the items property value. Retrieved list of AWS infrastructure access role grants.
    ...
    /**
     * Sets the items property value. Retrieved list of AWS infrastructure access role grants.
     * @param value Value to set for the items property.
     */
    public set items(value: AWSInfrastructureAccessRoleGrant[] | undefined) {
        this._items = value;
    };
    /**
    ...
    public serialize(writer: SerializationWriter) : void {
        ...
        writer.writeCollectionOfObjectValues<AWSInfrastructureAccessRoleGrant>("items", this.items);
