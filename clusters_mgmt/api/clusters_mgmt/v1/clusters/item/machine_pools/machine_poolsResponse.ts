...
export class Machine_poolsResponse implements AdditionalDataHolder, Parsable {
    /** Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well. */
    private _additionalData: Record<string, unknown>;
    /** Retrieved list of machine pools. */
    private _items?: MachinePool[] | undefined;
    ...
    /**
     * Instantiates a new machine_poolsResponse and sets the default values.
     */
    public constructor() {
    ...
    public getFieldDeserializers() : Record<string, (node: ParseNode) => void> {
        return {
            "items": n => { this.items = n.getCollectionOfObjectValues<MachinePool>(createMachinePoolFromDiscriminatorValue); },
    ...
    /**
     * Gets the items property value. Retrieved list of machine pools.
    ...
    /**
     * Sets the items property value. Retrieved list of machine pools.
     * @param value Value to set for the items property.
     */
    public set items(value: MachinePool[] | undefined) {
        this._items = value;
    };
    /**
    ...
    public serialize(writer: SerializationWriter) : void {
        ...
        writer.writeCollectionOfObjectValues<MachinePool>("items", this.items);
