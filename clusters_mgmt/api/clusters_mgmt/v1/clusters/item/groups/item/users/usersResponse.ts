...
export class UsersResponse implements AdditionalDataHolder, Parsable {
    /** Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well. */
    private _additionalData: Record<string, unknown>;
    /** Retrieved list of users. */
    private _items?: User[] | undefined;
    ...
    public getFieldDeserializers() : Record<string, (node: ParseNode) => void> {
        return {
            "items": n => { this.items = n.getCollectionOfObjectValues<User>(createUserFromDiscriminatorValue); },
    ...
    /**
     * Gets the items property value. Retrieved list of users.
     * @returns a User
     */
    public get items() {
        return this._items;
    ...
    /**
     * Sets the items property value. Retrieved list of users.
     * @param value Value to set for the items property.
     */
    public set items(value: User[] | undefined) {
        this._items = value;
    };
    /**
    ...
    public serialize(writer: SerializationWriter) : void {
        ...
        writer.writeCollectionOfObjectValues<User>("items", this.items);
