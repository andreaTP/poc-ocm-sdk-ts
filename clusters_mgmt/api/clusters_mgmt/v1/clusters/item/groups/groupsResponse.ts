...
export class GroupsResponse implements AdditionalDataHolder, Parsable {
    /** Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well. */
    private _additionalData: Record<string, unknown>;
    /** Retrieved list of groups. */
    private _items?: Group[] | undefined;
    ...
    public getFieldDeserializers() : Record<string, (node: ParseNode) => void> {
        return {
            "items": n => { this.items = n.getCollectionOfObjectValues<Group>(createGroupFromDiscriminatorValue); },
    ...
    /**
     * Gets the items property value. Retrieved list of groups.
     * @returns a Group
     */
    public get items() {
        return this._items;
    ...
    /**
     * Sets the items property value. Retrieved list of groups.
     * @param value Value to set for the items property.
     */
    public set items(value: Group[] | undefined) {
        this._items = value;
    };
    /**
    ...
    public serialize(writer: SerializationWriter) : void {
        ...
        writer.writeCollectionOfObjectValues<Group>("items", this.items);
