...
export class Node_poolsResponse implements AdditionalDataHolder, Parsable {
    /** Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well. */
    private _additionalData: Record<string, unknown>;
    /** Retrieved list of node pools. */
    private _items?: NodePool[] | undefined;
    ...
    /**
     * Instantiates a new node_poolsResponse and sets the default values.
     */
    public constructor() {
    ...
    public getFieldDeserializers() : Record<string, (node: ParseNode) => void> {
        return {
            "items": n => { this.items = n.getCollectionOfObjectValues<NodePool>(createNodePoolFromDiscriminatorValue); },
    ...
    /**
     * Gets the items property value. Retrieved list of node pools.
     * @returns a NodePool
     */
    public get items() {
        return this._items;
    ...
    /**
     * Sets the items property value. Retrieved list of node pools.
     * @param value Value to set for the items property.
     */
    public set items(value: NodePool[] | undefined) {
        this._items = value;
    };
    /**
    ...
    public serialize(writer: SerializationWriter) : void {
        ...
        writer.writeCollectionOfObjectValues<NodePool>("items", this.items);
