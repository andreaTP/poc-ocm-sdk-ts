...
export class AddonsResponse implements AdditionalDataHolder, Parsable {
    /** Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well. */
    private _additionalData: Record<string, unknown>;
    /** Retrieved list of add-on installations. */
    private _items?: AddOnInstallation[] | undefined;
    ...
    /**
     * Instantiates a new addonsResponse and sets the default values.
     */
    public constructor() {
    ...
    public getFieldDeserializers() : Record<string, (node: ParseNode) => void> {
        return {
            "items": n => { this.items = n.getCollectionOfObjectValues<AddOnInstallation>(createAddOnInstallationFromDiscriminatorValue); },
    ...
    /**
     * Gets the items property value. Retrieved list of add-on installations.
    ...
    /**
     * Sets the items property value. Retrieved list of add-on installations.
     * @param value Value to set for the items property.
     */
    public set items(value: AddOnInstallation[] | undefined) {
        this._items = value;
    };
    /**
    ...
    public serialize(writer: SerializationWriter) : void {
        ...
        writer.writeCollectionOfObjectValues<AddOnInstallation>("items", this.items);
