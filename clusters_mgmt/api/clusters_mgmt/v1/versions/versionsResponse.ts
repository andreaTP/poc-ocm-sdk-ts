...
export class VersionsResponse implements AdditionalDataHolder, Parsable {
    ...
    private _items?: Version[] | undefined;
    ...
    public getFieldDeserializers() : Record<string, (node: ParseNode) => void> {
        return {
            "items": n => { this.items = n.getCollectionOfObjectValues<Version>(createVersionFromDiscriminatorValue); },
    ...
    /**
     * Gets the items property value. Retrieved list of versions.
     * @returns a Version
     */
    public get items() {
        return this._items;
    ...
    /**
     * Sets the items property value. Retrieved list of versions.
     * @param value Value to set for the items property.
     */
    public set items(value: Version[] | undefined) {
        this._items = value;
    };
    /**
    ...
    public serialize(writer: SerializationWriter) : void {
        ...
        writer.writeCollectionOfObjectValues<Version>("items", this.items);
