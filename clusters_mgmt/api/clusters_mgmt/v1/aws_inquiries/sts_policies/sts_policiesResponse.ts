import {AWSSTSPolicy} from '../../../../../models/';
import {createAWSSTSPolicyFromDiscriminatorValue} from '../../../../../models/createAWSSTSPolicyFromDiscriminatorValue';
import {AdditionalDataHolder, Parsable, ParseNode, SerializationWriter} from '@microsoft/kiota-abstractions';

export class Sts_policiesResponse implements AdditionalDataHolder, Parsable {
    /** Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well. */
    private _additionalData: Record<string, unknown>;
    /** Retrieved list of policies. */
    private _items?: AWSSTSPolicy[] | undefined;
    ...
    /**
     * Instantiates a new sts_policiesResponse and sets the default values.
     */
    public constructor() {
    ...
    public getFieldDeserializers() : Record<string, (node: ParseNode) => void> {
        return {
            "items": n => { this.items = n.getCollectionOfObjectValues<AWSSTSPolicy>(createAWSSTSPolicyFromDiscriminatorValue); },
    ...
    /**
     * Gets the items property value. Retrieved list of policies.
     * @returns a AWSSTSPolicy
     */
    public get items() {
        return this._items;
    };
    /**
     * Sets the items property value. Retrieved list of policies.
     * @param value Value to set for the items property.
     */
    public set items(value: AWSSTSPolicy[] | undefined) {
        this._items = value;
    };
    /**
    ...
    public serialize(writer: SerializationWriter) : void {
        ...
        writer.writeCollectionOfObjectValues<AWSSTSPolicy>("items", this.items);
