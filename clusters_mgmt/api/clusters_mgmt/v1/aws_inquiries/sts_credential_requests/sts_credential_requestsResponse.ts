import {STSCredentialRequest} from '../../../../../models/';
import {createSTSCredentialRequestFromDiscriminatorValue} from '../../../../../models/createSTSCredentialRequestFromDiscriminatorValue';
import {AdditionalDataHolder, Parsable, ParseNode, SerializationWriter} from '@microsoft/kiota-abstractions';

export class Sts_credential_requestsResponse implements AdditionalDataHolder, Parsable {
    /** Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well. */
    private _additionalData: Record<string, unknown>;
    /** Retrieved list of CredRequest. */
    private _items?: STSCredentialRequest[] | undefined;
    ...
    /**
     * Instantiates a new sts_credential_requestsResponse and sets the default values.
     */
    public constructor() {
    ...
    public getFieldDeserializers() : Record<string, (node: ParseNode) => void> {
        return {
            "items": n => { this.items = n.getCollectionOfObjectValues<STSCredentialRequest>(createSTSCredentialRequestFromDiscriminatorValue); },
    ...
    /**
     * Gets the items property value. Retrieved list of CredRequest.
     * @returns a STSCredentialRequest
     */
    public get items() {
        return this._items;
    };
    /**
     * Sets the items property value. Retrieved list of CredRequest.
     * @param value Value to set for the items property.
     */
    public set items(value: STSCredentialRequest[] | undefined) {
        this._items = value;
    };
    /**
    ...
    public serialize(writer: SerializationWriter) : void {
        ...
        writer.writeCollectionOfObjectValues<STSCredentialRequest>("items", this.items);
