...
export class Limited_support_reason_templatesResponse implements AdditionalDataHolder, Parsable {
    /** Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well. */
    private _additionalData: Record<string, unknown>;
    /** Retrieved list of template. */
    private _items?: LimitedSupportReasonTemplate[] | undefined;
    ...
    /**
     * Instantiates a new limited_support_reason_templatesResponse and sets the default values.
     */
    public constructor() {
    ...
    public getFieldDeserializers() : Record<string, (node: ParseNode) => void> {
        return {
            "items": n => { this.items = n.getCollectionOfObjectValues<LimitedSupportReasonTemplate>(createLimitedSupportReasonTemplateFromDiscriminatorValue); },
    ...
    /**
     * Gets the items property value. Retrieved list of template.
    ...
    /**
     * Sets the items property value. Retrieved list of template.
     * @param value Value to set for the items property.
     */
    public set items(value: LimitedSupportReasonTemplate[] | undefined) {
        this._items = value;
    };
    /**
    ...
    public serialize(writer: SerializationWriter) : void {
        ...
        writer.writeCollectionOfObjectValues<LimitedSupportReasonTemplate>("items", this.items);
