...
import {ClusterManagementReference, DNS} from './index';
 ...
 */
export class ServiceCluster implements AdditionalDataHolder, Parsable {
    ...
    /** Indicates the type of this object. Will be 'ServiceCluster' if this is a complete object or 'ServiceClusterLink' if it is just a link. */
    ...
    /**
     * Instantiates a new ServiceCluster and sets the default values.
     */
    public constructor() {
    ...
    /**
     * Gets the kind property value. Indicates the type of this object. Will be 'ServiceCluster' if this is a complete object or 'ServiceClusterLink' if it is just a link.
     * @returns a string
     */
    public get kind() {
        return this._kind;
    ...
    /**
     * Sets the kind property value. Indicates the type of this object. Will be 'ServiceCluster' if this is a complete object or 'ServiceClusterLink' if it is just a link.
