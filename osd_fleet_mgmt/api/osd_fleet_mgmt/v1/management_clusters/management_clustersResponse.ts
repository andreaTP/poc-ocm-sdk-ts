import {ManagementCluster} from '../../../../models/';
...
export class Management_clustersResponse implements AdditionalDataHolder, Parsable {
    /** Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well. */
    private _additionalData: Record<string, unknown>;
    /** Retrieved a list of management clusters. */
    private _items?: ManagementCluster[] | undefined;
    ...
    /**
     * Instantiates a new management_clustersResponse and sets the default values.
     */
    public constructor() {
    ...
    public getFieldDeserializers() : Record<string, (node: ParseNode) => void> {
        return {
            "items": n => { this.items = n.getCollectionOfObjectValues<ManagementCluster>(createManagementClusterFromDiscriminatorValue); },
    ...
    /**
     * Gets the items property value. Retrieved a list of management clusters.
     * @returns a ManagementCluster
     */
    public get items() {
        return this._items;
    };
    /**
     * Sets the items property value. Retrieved a list of management clusters.
     * @param value Value to set for the items property.
     */
    public set items(value: ManagementCluster[] | undefined) {
        this._items = value;
    };
    /**
    ...
    public serialize(writer: SerializationWriter) : void {
        ...
        writer.writeCollectionOfObjectValues<ManagementCluster>("items", this.items);
