 ...
 */
export class AuthorizationsApiClient {
    /** The api property */
    ...
    /**
     * Instantiates a new AuthorizationsApiClient and sets the default values.
    ...
    public constructor(requestAdapter: RequestAdapter) {
        ...
        if (requestAdapter.baseUrl === undefined || requestAdapter.baseUrl === "") {
            requestAdapter.baseUrl = "https://api.openshift.com";
        }
