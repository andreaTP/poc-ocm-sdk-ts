...
/**
 * Builds and executes requests for operations under /api/authorizations
 */
export class AuthorizationsRequestBuilder {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/api/authorizations";
