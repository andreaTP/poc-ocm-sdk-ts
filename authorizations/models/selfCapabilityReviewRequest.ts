 ...
 */
export class SelfCapabilityReviewRequest implements AdditionalDataHolder, Parsable {
    ...
    /**
     * Instantiates a new SelfCapabilityReviewRequest and sets the default values.
     */
    public constructor() {
