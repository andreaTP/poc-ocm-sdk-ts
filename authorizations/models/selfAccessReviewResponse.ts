 ...
 */
export class SelfAccessReviewResponse implements AdditionalDataHolder, Parsable {
    ...
    /**
     * Gets the allowed property value. Defines whether the action on the specified resource type is allowed
     * @returns a boolean
     */
    public get allowed() {
    ...
    /**
     * Sets the allowed property value. Defines whether the action on the specified resource type is allowed
    ...
    /**
     * Instantiates a new SelfAccessReviewResponse and sets the default values.
     */
    public constructor() {
