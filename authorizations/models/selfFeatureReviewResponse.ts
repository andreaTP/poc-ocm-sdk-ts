 ...
 */
export class SelfFeatureReviewResponse implements AdditionalDataHolder, Parsable {
    ...
    /**
     * Instantiates a new SelfFeatureReviewResponse and sets the default values.
     */
    public constructor() {
