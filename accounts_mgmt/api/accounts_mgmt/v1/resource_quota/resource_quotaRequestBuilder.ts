...
/**
 * Builds and executes requests for operations under /api/accounts_mgmt/v1/resource_quota
 */
export class Resource_quotaRequestBuilder {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/api/accounts_mgmt/v1/resource_quota{?page*,search*,size*}";
