...
export class Resource_quotaResponse implements AdditionalDataHolder, Parsable {
    /** Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well. */
    private _additionalData: Record<string, unknown>;
    /** Retrieved list of resource quotas. */
    private _items?: ResourceQuota[] | undefined;
    ...
    /**
     * Instantiates a new resource_quotaResponse and sets the default values.
     */
    public constructor() {
    ...
    public getFieldDeserializers() : Record<string, (node: ParseNode) => void> {
        return {
            "items": n => { this.items = n.getCollectionOfObjectValues<ResourceQuota>(createResourceQuotaFromDiscriminatorValue); },
    ...
    /**
     * Gets the items property value. Retrieved list of resource quotas.
     * @returns a ResourceQuota
     */
    public get items() {
        return this._items;
    };
    /**
     * Sets the items property value. Retrieved list of resource quotas.
     * @param value Value to set for the items property.
     */
    public set items(value: ResourceQuota[] | undefined) {
        this._items = value;
    };
    /**
    ...
    public serialize(writer: SerializationWriter) : void {
        ...
        writer.writeCollectionOfObjectValues<ResourceQuota>("items", this.items);
