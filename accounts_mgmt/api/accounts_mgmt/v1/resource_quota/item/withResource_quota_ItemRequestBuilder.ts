...
/**
 * Builds and executes requests for operations under /api/accounts_mgmt/v1/resource_quota/{resource_quota_id}
 */
export class WithResource_quota_ItemRequestBuilder {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/api/accounts_mgmt/v1/resource_quota/{resource_quota_id}";
