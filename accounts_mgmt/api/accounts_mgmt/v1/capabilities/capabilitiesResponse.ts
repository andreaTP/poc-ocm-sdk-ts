...
import {createCapabilityFromDiscriminatorValue} from '../../../../models/createCapabilityFromDiscriminatorValue';
import {AdditionalDataHolder, Parsable, ParseNode, SerializationWriter} from '@microsoft/kiota-abstractions';

export class CapabilitiesResponse implements AdditionalDataHolder, Parsable {
    /** Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well. */
    private _additionalData: Record<string, unknown>;
    /** Retrieved list of Capabilities. */
    private _items?: Capability[] | undefined;
    ...
    /**
     * Instantiates a new capabilitiesResponse and sets the default values.
     */
    public constructor() {
    ...
    public getFieldDeserializers() : Record<string, (node: ParseNode) => void> {
        return {
            "items": n => { this.items = n.getCollectionOfObjectValues<Capability>(createCapabilityFromDiscriminatorValue); },
    ...
    /**
     * Gets the items property value. Retrieved list of Capabilities.
    ...
    /**
     * Sets the items property value. Retrieved list of Capabilities.
     * @param value Value to set for the items property.
     */
    public set items(value: Capability[] | undefined) {
        this._items = value;
    };
    /**
    ...
    public serialize(writer: SerializationWriter) : void {
        ...
        writer.writeCollectionOfObjectValues<Capability>("items", this.items);
