...
export class Sku_rulesResponse implements AdditionalDataHolder, Parsable {
    /** Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well. */
    private _additionalData: Record<string, unknown>;
    /** Retrieved list of Sku Rules. */
    private _items?: SkuRule[] | undefined;
    ...
    /**
     * Instantiates a new sku_rulesResponse and sets the default values.
     */
    public constructor() {
    ...
    public getFieldDeserializers() : Record<string, (node: ParseNode) => void> {
        return {
            "items": n => { this.items = n.getCollectionOfObjectValues<SkuRule>(createSkuRuleFromDiscriminatorValue); },
    ...
    /**
     * Gets the items property value. Retrieved list of Sku Rules.
     * @returns a SkuRule
     */
    public get items() {
        return this._items;
    ...
    /**
     * Sets the items property value. Retrieved list of Sku Rules.
     * @param value Value to set for the items property.
     */
    public set items(value: SkuRule[] | undefined) {
        this._items = value;
    };
    /**
    ...
    public serialize(writer: SerializationWriter) : void {
        ...
        writer.writeCollectionOfObjectValues<SkuRule>("items", this.items);
