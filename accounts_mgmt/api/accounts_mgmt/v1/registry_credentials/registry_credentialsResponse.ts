...
export class Registry_credentialsResponse implements AdditionalDataHolder, Parsable {
    /** Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well. */
    private _additionalData: Record<string, unknown>;
    /** Retrieved list of registry credentials. */
    private _items?: RegistryCredential[] | undefined;
    ...
    /**
     * Instantiates a new registry_credentialsResponse and sets the default values.
     */
    public constructor() {
    ...
    public getFieldDeserializers() : Record<string, (node: ParseNode) => void> {
        return {
            "items": n => { this.items = n.getCollectionOfObjectValues<RegistryCredential>(createRegistryCredentialFromDiscriminatorValue); },
    ...
    /**
     * Gets the items property value. Retrieved list of registry credentials.
     * @returns a RegistryCredential
     */
    public get items() {
        return this._items;
    };
    /**
     * Sets the items property value. Retrieved list of registry credentials.
     * @param value Value to set for the items property.
     */
    public set items(value: RegistryCredential[] | undefined) {
        this._items = value;
    };
    /**
    ...
    public serialize(writer: SerializationWriter) : void {
        ...
        writer.writeCollectionOfObjectValues<RegistryCredential>("items", this.items);
