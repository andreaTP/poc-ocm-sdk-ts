...
export class Cloud_resourcesResponse implements AdditionalDataHolder, Parsable {
    /** Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well. */
    private _additionalData: Record<string, unknown>;
    /** Retrieved list of cloud resources. */
    private _items?: CloudResource[] | undefined;
    ...
    /**
     * Instantiates a new cloud_resourcesResponse and sets the default values.
     */
    public constructor() {
    ...
    public getFieldDeserializers() : Record<string, (node: ParseNode) => void> {
        return {
            "items": n => { this.items = n.getCollectionOfObjectValues<CloudResource>(createCloudResourceFromDiscriminatorValue); },
    ...
    /**
     * Gets the items property value. Retrieved list of cloud resources.
     * @returns a CloudResource
     */
    public get items() {
        return this._items;
    };
    /**
     * Sets the items property value. Retrieved list of cloud resources.
     * @param value Value to set for the items property.
     */
    public set items(value: CloudResource[] | undefined) {
        this._items = value;
    };
    /**
    ...
    public serialize(writer: SerializationWriter) : void {
        ...
        writer.writeCollectionOfObjectValues<CloudResource>("items", this.items);
