...
export class Role_bindingsResponse implements AdditionalDataHolder, Parsable {
    /** Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well. */
    private _additionalData: Record<string, unknown>;
    /** Retrieved list of role bindings. */
    private _items?: RoleBinding[] | undefined;
    ...
    /**
     * Instantiates a new role_bindingsResponse and sets the default values.
     */
    public constructor() {
    ...
    public getFieldDeserializers() : Record<string, (node: ParseNode) => void> {
        return {
            "items": n => { this.items = n.getCollectionOfObjectValues<RoleBinding>(createRoleBindingFromDiscriminatorValue); },
    ...
    /**
     * Gets the items property value. Retrieved list of role bindings.
     * @returns a RoleBinding
     */
    public get items() {
        return this._items;
    };
    /**
     * Sets the items property value. Retrieved list of role bindings.
     * @param value Value to set for the items property.
     */
    public set items(value: RoleBinding[] | undefined) {
        this._items = value;
    };
    /**
    ...
    public serialize(writer: SerializationWriter) : void {
        ...
        writer.writeCollectionOfObjectValues<RoleBinding>("items", this.items);
