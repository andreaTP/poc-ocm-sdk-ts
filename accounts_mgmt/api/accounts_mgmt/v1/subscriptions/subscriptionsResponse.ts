...
export class SubscriptionsResponse implements AdditionalDataHolder, Parsable {
    /** Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well. */
    private _additionalData: Record<string, unknown>;
    /** Retrieved list of subscriptions. */
    private _items?: Subscription[] | undefined;
    ...
    public getFieldDeserializers() : Record<string, (node: ParseNode) => void> {
        return {
            "items": n => { this.items = n.getCollectionOfObjectValues<Subscription>(createSubscriptionFromDiscriminatorValue); },
    ...
    /**
     * Gets the items property value. Retrieved list of subscriptions.
    ...
    /**
     * Sets the items property value. Retrieved list of subscriptions.
     * @param value Value to set for the items property.
     */
    public set items(value: Subscription[] | undefined) {
        this._items = value;
    };
    /**
    ...
    public serialize(writer: SerializationWriter) : void {
        ...
        writer.writeCollectionOfObjectValues<Subscription>("items", this.items);
