...
/**
 * Builds and executes requests for operations under /api/accounts_mgmt/v1/subscriptions/{subscription_id}/role_bindings/{role_binding_id}
 */
export class WithRole_binding_ItemRequestBuilder {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/api/accounts_mgmt/v1/subscriptions/{subscription_id}/role_bindings/{role_binding_id}";
