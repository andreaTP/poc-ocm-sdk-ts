...
export class Reserved_resourcesResponse implements AdditionalDataHolder, Parsable {
    /** Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well. */
    private _additionalData: Record<string, unknown>;
    /** Retrieved list of reserved resources. */
    private _items?: ReservedResource[] | undefined;
    ...
    /**
     * Instantiates a new reserved_resourcesResponse and sets the default values.
     */
    public constructor() {
    ...
    public getFieldDeserializers() : Record<string, (node: ParseNode) => void> {
        return {
            "items": n => { this.items = n.getCollectionOfObjectValues<ReservedResource>(createReservedResourceFromDiscriminatorValue); },
    ...
    /**
     * Gets the items property value. Retrieved list of reserved resources.
    ...
    /**
     * Sets the items property value. Retrieved list of reserved resources.
     * @param value Value to set for the items property.
     */
    public set items(value: ReservedResource[] | undefined) {
        this._items = value;
    };
    /**
    ...
    public serialize(writer: SerializationWriter) : void {
        ...
        writer.writeCollectionOfObjectValues<ReservedResource>("items", this.items);
