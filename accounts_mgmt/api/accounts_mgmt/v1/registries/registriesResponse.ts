...
export class RegistriesResponse implements AdditionalDataHolder, Parsable {
    /** Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well. */
    private _additionalData: Record<string, unknown>;
    /** Retrieved list of registries. */
    private _items?: Registry[] | undefined;
    ...
    /**
     * Instantiates a new registriesResponse and sets the default values.
     */
    public constructor() {
    ...
    public getFieldDeserializers() : Record<string, (node: ParseNode) => void> {
        return {
            "items": n => { this.items = n.getCollectionOfObjectValues<Registry>(createRegistryFromDiscriminatorValue); },
    ...
    /**
     * Gets the items property value. Retrieved list of registries.
     * @returns a Registry
     */
    public get items() {
        return this._items;
    ...
    /**
     * Sets the items property value. Retrieved list of registries.
     * @param value Value to set for the items property.
     */
    public set items(value: Registry[] | undefined) {
        this._items = value;
    };
    /**
    ...
    public serialize(writer: SerializationWriter) : void {
        ...
        writer.writeCollectionOfObjectValues<Registry>("items", this.items);
