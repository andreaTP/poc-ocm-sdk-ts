...
export class AccountsResponse implements AdditionalDataHolder, Parsable {
    /** Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well. */
    private _additionalData: Record<string, unknown>;
    /** Retrieved list of accounts. */
    private _items?: Account[] | undefined;
    ...
    public getFieldDeserializers() : Record<string, (node: ParseNode) => void> {
        return {
            "items": n => { this.items = n.getCollectionOfObjectValues<Account>(createAccountFromDiscriminatorValue); },
    ...
    /**
     * Gets the items property value. Retrieved list of accounts.
     * @returns a Account
     */
    public get items() {
        return this._items;
    ...
    /**
     * Sets the items property value. Retrieved list of accounts.
     * @param value Value to set for the items property.
     */
    public set items(value: Account[] | undefined) {
        this._items = value;
    };
    /**
    ...
    public serialize(writer: SerializationWriter) : void {
        ...
        writer.writeCollectionOfObjectValues<Account>("items", this.items);
