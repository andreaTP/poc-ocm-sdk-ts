...
/**
 * Builds and executes requests for operations under /api/accounts_mgmt/v1/accounts/{account_id}/labels
 */
export class LabelsRequestBuilder {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/api/accounts_mgmt/v1/accounts/{account_id}/labels{?page*,size*}";
    ...
    /**
     * Gets an item from the ApiSdk.api.accounts_mgmt.v1.accounts.item.labels.item collection
