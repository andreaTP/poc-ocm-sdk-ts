...
import {createDeletedSubscriptionFromDiscriminatorValue} from '../../../../models/createDeletedSubscriptionFromDiscriminatorValue';
import {AdditionalDataHolder, Parsable, ParseNode, SerializationWriter} from '@microsoft/kiota-abstractions';

export class Deleted_subscriptionsResponse implements AdditionalDataHolder, Parsable {
    /** Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well. */
    private _additionalData: Record<string, unknown>;
    /** Retrieved list of DeletedSubscriptions. */
    private _items?: DeletedSubscription[] | undefined;
    ...
    /**
     * Instantiates a new deleted_subscriptionsResponse and sets the default values.
     */
    public constructor() {
    ...
    public getFieldDeserializers() : Record<string, (node: ParseNode) => void> {
        return {
            "items": n => { this.items = n.getCollectionOfObjectValues<DeletedSubscription>(createDeletedSubscriptionFromDiscriminatorValue); },
    ...
    /**
     * Gets the items property value. Retrieved list of DeletedSubscriptions.
     * @returns a DeletedSubscription
     */
    public get items() {
        return this._items;
    };
    /**
     * Sets the items property value. Retrieved list of DeletedSubscriptions.
     * @param value Value to set for the items property.
     */
    public set items(value: DeletedSubscription[] | undefined) {
        this._items = value;
    };
    /**
    ...
    public serialize(writer: SerializationWriter) : void {
        ...
        writer.writeCollectionOfObjectValues<DeletedSubscription>("items", this.items);
