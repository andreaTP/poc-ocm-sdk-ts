...
import {WithLabel_ItemRequestBuilder} from '../../../subscriptions/labels/item/withLabel_ItemRequestBuilder';
import {WithLabels_ItemRequestBuilder} from '../../../subscriptions/labels/item/withLabels_ItemRequestBuilder';
...
/**
 * Builds and executes requests for operations under /api/accounts_mgmt/v1/organizations/{organization_id}/labels
 */
export class LabelsRequestBuilder {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/api/accounts_mgmt/v1/organizations/{organization_id}/labels{?page*,size*}";
    ...
    /**
     * Gets an item from the ApiSdk.api.accounts_mgmt.v1.organizations.item.labels.item collection
