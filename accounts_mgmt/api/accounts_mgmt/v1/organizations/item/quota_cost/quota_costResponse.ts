import {QuotaCost} from '../../../../../../models/';
import {createQuotaCostFromDiscriminatorValue} from '../../../../../../models/createQuotaCostFromDiscriminatorValue';
import {AdditionalDataHolder, Parsable, ParseNode, SerializationWriter} from '@microsoft/kiota-abstractions';

export class Quota_costResponse implements AdditionalDataHolder, Parsable {
    /** Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well. */
    private _additionalData: Record<string, unknown>;
    /** Retrieved quota cost items. */
    private _items?: QuotaCost[] | undefined;
    ...
    /**
     * Instantiates a new quota_costResponse and sets the default values.
     */
    public constructor() {
    ...
    public getFieldDeserializers() : Record<string, (node: ParseNode) => void> {
        return {
            "items": n => { this.items = n.getCollectionOfObjectValues<QuotaCost>(createQuotaCostFromDiscriminatorValue); },
    ...
    /**
     * Gets the items property value. Retrieved quota cost items.
     * @returns a QuotaCost
     */
    public get items() {
        return this._items;
    ...
    /**
     * Sets the items property value. Retrieved quota cost items.
     * @param value Value to set for the items property.
     */
    public set items(value: QuotaCost[] | undefined) {
        this._items = value;
    };
    /**
    ...
    public serialize(writer: SerializationWriter) : void {
        ...
        writer.writeCollectionOfObjectValues<QuotaCost>("items", this.items);
