...
export class OrganizationsResponse implements AdditionalDataHolder, Parsable {
    /** Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well. */
    private _additionalData: Record<string, unknown>;
    /** Retrieved list of organizations. */
    private _items?: Organization[] | undefined;
    ...
    /**
     * Instantiates a new organizationsResponse and sets the default values.
     */
    public constructor() {
    ...
    public getFieldDeserializers() : Record<string, (node: ParseNode) => void> {
        return {
            "items": n => { this.items = n.getCollectionOfObjectValues<Organization>(createOrganizationFromDiscriminatorValue); },
    ...
    /**
     * Gets the items property value. Retrieved list of organizations.
    ...
    /**
     * Sets the items property value. Retrieved list of organizations.
     * @param value Value to set for the items property.
     */
    public set items(value: Organization[] | undefined) {
        this._items = value;
    };
    /**
    ...
    public serialize(writer: SerializationWriter) : void {
        ...
        writer.writeCollectionOfObjectValues<Organization>("items", this.items);
