...
export class Role implements AdditionalDataHolder, Parsable {
    ...
    /** Indicates the type of this object. Will be 'Role' if this is a complete object or 'RoleLink' if it is just a link. */
    ...
    /**
     * Gets the kind property value. Indicates the type of this object. Will be 'Role' if this is a complete object or 'RoleLink' if it is just a link.
     * @returns a string
     */
    public get kind() {
        return this._kind;
    ...
    /**
     * Sets the kind property value. Indicates the type of this object. Will be 'Role' if this is a complete object or 'RoleLink' if it is just a link.
