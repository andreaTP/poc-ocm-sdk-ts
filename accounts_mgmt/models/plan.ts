...
export class Plan implements AdditionalDataHolder, Parsable {
    ...
    /**
     * Gets the kind property value. Indicates the type of this object. Will be 'Plan' if this is a complete object or 'PlanLink' if it is just a link.
     * @returns a string
     */
    public get kind() {
        return this._kind;
    ...
    /**
     * Sets the kind property value. Indicates the type of this object. Will be 'Plan' if this is a complete object or 'PlanLink' if it is just a link.
